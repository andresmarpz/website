  ...
  return (
    <div>
      <CaseStudyLayout
        ...
        description={
          <>
            React Web application that allows users to search for Rick and Morty
            characters, locations and episodes. Implements the
            <Link href="https://rickandmortyapi.com">rickandmortyapi.com</Link>
      ...
      <Paragraph css={{ lineHeight: 1.6 }}>
        ...
        but still have a solid level of complexity to work with. <br />I focused
        on learning about Next.js and its environment, considering multiple data
        fetching methods and how to implement them in a performant and smooth
        way, avoiding loading states as much as possible.
      </Paragraph>
      ...
      <Paragraph css={{ lineHeight: 1.6 }}>
        ...
        Next.js, paired with <Code>useSWR</Code> to keep the data fetched cached
        and avoid unnecessary requests. <br />
      </Paragraph>
      ...
      <Paragraph>
        Using Radix was a breeze. It&apos;s a great library that provides a lot
        of components and utilities that just work. Although, I had an issue
        where the tabs unmounted when switching, losing the pagination state and
        having to re-populate the data every time. I spent quite a while and too
        many coffees figuring out the solution, but I ended up preventing the
        unmount, and everything else worked just fine.
        <br />
        <br />
